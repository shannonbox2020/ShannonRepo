	...
	public class WaitTool {
		...
		public static WebElement waitForElement(WebDriver driver, final By by, int timeOutInSeconds) {
			...
			try{	
				...
				e.printStackTrace();
				Assert.fail("Web Element with locator: "+by+" is not visible. Exception message: "+e.getMessage());
			} 
			return null; 
		}
		...
		public static WebElement waitForElementPresent(WebDriver driver, final By by, int timeOutInSeconds) {
			...
			try{
				...
				e.printStackTrace();
				Assert.fail("Web Element with locator: "+by+" is not displayed. Exception message: "+e.getMessage());
			} 
			return null; 
		}
		...
		public static List<WebElement> waitForListElementsPresent(WebDriver driver, final By by, int timeOutInSeconds) {
			...
			try{	
				...
				e.printStackTrace();
				Assert.fail("Web Elements with locator: "+by+" is not displayed. Exception message: "+e.getMessage());
			} 
			return null; 
		}
		...
		/**
		 ...
		 public static WebElement waitForElementRefresh(WebDriver driver, final By by, 
			...
			try{	
				...
				e.printStackTrace();
				Assert.fail("Web Element with locator: "+by+" is not displayed after refreshing. Exception message: "+e.getMessage());
			} 
			return null; 
		 }
		...
		public static boolean waitForTextPresent(WebDriver driver, final By by, final String text, int timeOutInSeconds) {
			...
			try{	
				...
				e.printStackTrace();
				Assert.fail("Web Element with locator: "+by+" is not displayed to verify text present verification. Exception message: "+e.getMessage());
			} 
			return false; 
		}
		...
		public static boolean waitForJavaScriptCondition(WebDriver driver, final String javaScript, 
			...
			try{	
				...
				e.printStackTrace();
				Assert.fail("Eception occured while waiting for Javascrit condition: "+javaScript+" . Exception message: "+e.getMessage());
			} 
			return false; 
		}
		...
		public static boolean waitForJQueryProcessing(WebDriver driver, int timeOutInSeconds){
			...
			try{	
				...
				e.printStackTrace();
				Assert.fail("Exception occured while waiting for jQuery processing. Exception message: "+e.getMessage());
			} 
			return jQcondition; 
	    }
